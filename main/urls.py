...
from .views import HomeView, EventView, DisplayEvent, ExpenseView, UpdateEventView, delete_event_view
...
urlpatterns = [
    ...
    path('event/delete/<int:pk>/', delete_event_view, name='delete_event'),
    ]